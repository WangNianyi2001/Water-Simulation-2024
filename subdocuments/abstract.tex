\begin{abstract}
	...
	To do it effectively, we proposed a real-time method for calculating the buoyant behavior of solid bodies submerged in fluid based on the Monte-Carlo method.
	...
	\begin{keywords}
		solid-fluid coupling; buoyancy; real-time; physical simulation; Monte-Carlo method
	\end{keywords}
\end{abstract}