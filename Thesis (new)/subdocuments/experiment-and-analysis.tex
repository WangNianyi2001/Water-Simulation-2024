	...
	\scalebox{1}{
		\begin{tikzpicture}
			\begin{axis}[
				...
				xlabel={time (seconds)},
				ylabel={meter},
				ymin=-4, ymax=6, ytick={-4,-3,...,6},
				axis y line*=left,
			]
				\addplot[black] coordinates { (0,0) (5,0) };
				\addplot[olive] table[x=t, y=com] {./figures/exp3/suzzane/ours.log};
				\addplot[blue] table[x=t, y=min] {./figures/exp3/suzzane/ours.log};
			\end{axis}
			\begin{axis}[
				width=5in, height=2in,
				enlargelimits=false,
				ylabel={degree},
				xtick=\empty,
				ymin=0, ymax=360, ytick={0,60,...,360},
				axis y line*=right,
				ylabel near ticks, yticklabel pos=right,
			]
				\addplot[color=red] table[x=t, y=rz] {./figures/exp3/suzzane/ours.log};
			\end{axis}
			\matrix [draw, below left, fill=white] at (4.25in, 1.25in) {
				\node[olive, font=\footnotesize] {center-of-mass}; \\
				\node[blue, font=\footnotesize] {lowest point}; \\
