...
The properties of the water is given in table \ref{simulation-water-properties} (the dissipation term is not used in this experiment).
...
\begin{figure*}[h]
	...
	\begin{tikzpicture}
		\begin{axis}[
			...
			\addplot[olive] table[x=t, y=com] {../Thesis/figures/no-resistance.dat};
			\addplot[blue] table[x=t, y=min] {../Thesis/figures/no-resistance.dat};
		\end{axis}
...
Based on the analysis of the result, our method has met the desired requirements on realism.
		...
		\scalebox{0.75}{
			\begin{tikzpicture}
				\begin{axis}[
					...
					\addplot[blue] table[x=t, y=fps] {../Thesis/figures/spawner-real.dat};
					\addplot[gray] table[x=t, y=fps] {../Thesis/figures/spawner-compare.dat};
				\end{axis}
				\begin{axis}[
					width=6in, height=2in,
					enlargelimits=false,
					...
					\addplot[red] table[x=t, y=n] {../Thesis/figures/spawner-real.dat};
				\end{axis}
				\matrix [draw, above left, fill=white] at (5.25in, 0.05in) {
