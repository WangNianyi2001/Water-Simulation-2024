\begin{abstract}
	...
	Experiments in real time environment demonstrate our approach's realism and scalability, and suggest its potential to generalize to other field-object interaction scenarios.
